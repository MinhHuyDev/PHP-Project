...
function shopeeWaybillTrack($waybill): array
{
  ...
  curl_setopt_array($curl, array(
    CURLOPT_URL => "https://spx.vn/api/v2/fleet_order/tracking/search?sls_tracking_number=" . encodedKey(resi : $waybill),
    ...
    CURLOPT_HTTPHEADER => array(
      ...
      "Referer: https://spx.vn/detail/$waybill",
...
var_dump(shopeeWaybillTrack('SPXVN030793413402'));
